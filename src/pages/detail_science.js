...
class Detail_science extends React.Component {
    ...
    getFoodDetail = async (foodCd, foodNm) => {
        ...
        const url = `https://cors-anywhere.herokuapp.com/http://apis.data.go.kr/B551553/TradFoodInfoService/getFoodHealthScholarList?serviceKey=lLjoGCVK2fzZyHfHUXBIhIbHxQ8GhCmNpnKeFx4m4cfeUuneSaQMdhnxVeAcbN9CtEcRBnmMphI7zSwJL%2BJ7sg%3D%3D&pageNo=1&numOfRows=10&foodCd=${foodCd}&type=JSON&SG_APIM=2ug8Dm9qNBfD32JLZGPN64f3EoTlkpD8kSOHWfXpyrY`
